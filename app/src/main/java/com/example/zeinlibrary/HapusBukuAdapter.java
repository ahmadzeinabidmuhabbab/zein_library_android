...
public class HapusBukuAdapter extends RecyclerView.Adapter<BukuHolder>{
    Context context;
    List<Buku> itemObjects;

    public HapusBukuAdapter(Context context, List<Buku> itemObjects) {
    ...
    public void onBindViewHolder(BukuHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, HapusActionBukuActivity.class);
